"""Installable for the Crawl4AI Docker image.
...
Crawl4AI ships a single multiarch image, so tags are arch-agnostic and
there is no host-arch filtering (cf. comfyui).
"""
...
class Crawl4AiImage(ServiceInstall):
    """Installable for the Crawl4AI Docker image.
    ...
    def __init__(
        ...
        *,
        ...
        image_repo: str,
        image_tag: str,
        secrets=None,  # accepted but unused for v1 (public Docker Hub)
    ) -> None:
    ...
    def source_url(self) -> str | None:
        return "https://hub.docker.com/r/unclecode/crawl4ai"
